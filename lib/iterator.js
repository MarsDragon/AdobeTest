...
=======
	//private variables for moving around the array
>>>>>>> parent of 3468868... Comments and refactoring
	...
	//Check if we're at the end of the array, then return the next value
	this.next = function () {
	...
	this.reverse = function () {
		...
		//this also has a problem where returning the same value means that if you reverse a newly-made array, you are at the end of the array and cannot go back. This could be fixed with a prev() function. That wasn't part of the challenge so I left it off, but it's something to keep in mind for the future
	}
};